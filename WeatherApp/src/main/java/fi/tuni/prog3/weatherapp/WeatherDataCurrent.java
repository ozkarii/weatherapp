...
/**
 * Class for storing CURRENT weather data. Inherits WeatherData.
 * @author Oskari Heinonen
 */
public class WeatherDataCurrent extends WeatherData {
    
    private TemperatureCurrent temp;
    private PrecipitationCurrent precipitation;
     ...
     */
    public WeatherDataCurrent(long time, int id, String iconId, String description, 
                              String city, Coord coord, TemperatureCurrent temp, int pressure,
                              int humidity, Wind wind, int clouds, PrecipitationCurrent precipitation, long sunrise,
     ...
     */
    public TemperatureCurrent getTemperature() {
        return temp;
    }
    /**
     ...
     */
    public PrecipitationCurrent getPrecipitation() {
